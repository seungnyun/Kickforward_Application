...
import com.example.Fragment.MyAdapter;

import java.util.ResourceBundle;

import me.relex.circleindicator.CircleIndicator3;

public class LoginOrJoinActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegiButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(getApplicationContext(),Join1Activity.class);
                startActivity(it);
            }
        });
